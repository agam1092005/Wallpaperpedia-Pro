...
String apiKEY = "563492ad6f917000010000019573fe6428244d06a1c94b650d646fb4";
...
List<CategoriesModal> getCategories() {
  ...
  categoriesModal.categoriesName = "Wild Life";
  categories.add(categoriesModal);
  categoriesModal = new CategoriesModal();
  ...
  categoriesModal.categoriesName = "City";
  categories.add(categoriesModal);
  categoriesModal = new CategoriesModal();

  categoriesModal.imageurl =
  "https://images.pexels.com/photos/1434819/pexels-photo-1434819.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260";
  categoriesModal.categoriesName = "Motivation";
  categories.add(categoriesModal);
  categoriesModal = new CategoriesModal();

  categoriesModal.imageurl =
  "https://images.pexels.com/photos/2116475/pexels-photo-2116475.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500";
  categoriesModal.categoriesName = "Bikes";
  categories.add(categoriesModal);
  categoriesModal = new CategoriesModal();
